...
- Number of pull requests created: **22**
	- Merged: **19**
	- Closed: **3**
	- Opening: **0**
- Number of solutions written by me: **19** (All of them are in `CPP`)
...
### [Introduction to Sorting](https://usaco.guide/bronze/intro-sorting?lang=cpp)
- [Codeforces - Kayaking](https://usaco.guide/solutions/cf-kayaking?lang=cpp)

### [Introduction to Sets & Maps](https://usaco.guide/bronze/intro-sets?lang=cpp)
- [Codeforces - Jury Marks](https://usaco.guide/solutions/jury-marks?lang=cpp)

### [Introduction to Graphs](https://usaco.guide/bronze/intro-graphs?lang=cpp)
- [Family Tree](https://usaco.guide/solutions/usaco-833?lang=cpp)
